...
describe("API V1", () => {
    describe("#scrapePlatziUser()", () => {
        it("should return \"Jecsham Castillo\" with the param \"@jecsham\"", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("#scrapePlatziUser() - private profile (403)", () => {
        it("should return status code 403 with the param \"@jcdevtest\"", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("#scrapePlatziUser() - error (404)", () => {
        it("should return status code 404 with the param \"randomroute\"", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe("#insertOrUpdateUser()", () => {
        it("should return true with the param apiv1.scrapePlatziUser(\"@jecsham\")", () => __awaiter(void 0, void 0, void 0, function* () {
            const data = yield api_v1_1.default.scrapePlatziUser("@jecsham");
